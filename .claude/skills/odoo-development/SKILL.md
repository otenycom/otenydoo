...
See [Testing Guidelines — CI-Safe Test Patterns](references/testing-guidelines.md#ci-safe-test-patterns-odoosh) for code examples, and [Odoo.sh CI Reference](references/odoosh-ci.md) for build debugging procedures (SSH, ir_logging queries, log inspection).
...
- [Knowledge Skill Sync](references/knowledge-skill-sync.md) - Syncing skills to Odoo Knowledge app
- [Parallel Test Runner](references/parallel-test-runner.md) - Parallelized Odoo test execution with LPT balancing (Developers)
- [SH Backup Restore](references/sh-backup-restore.md) - Auto-detecting fast restore for lite SH backups with filestore preservation and cross-db hardlinking (Developers)
...
- [Deploy Tool](references/deploy-tool.md) - RiverDeploy CI pipeline, staging environments, deploy commands, and launch configs (Developers)
- [Odoo.sh CI Reference](references/odoosh-ci.md) - Build failure detection (ir_logging, console output), common noise sources, and SSH debugging procedures (Developers)
